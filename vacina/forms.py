...
class Profile(forms.Form):
    ...
    telefone = forms.CharField(
        label='Telefone', max_length=100, help_text="(xx) xxxxxxxx")
    ...
    password = forms.CharField(
        label='Nova senha', widget=forms.PasswordInput, max_length=100)
    confirm = forms.CharField(
        label='Confirmar nova senha', widget=forms.PasswordInput, max_length=100)
